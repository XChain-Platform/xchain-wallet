...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-470%20smokes%20%2B%20Playwright%20E2E-brightgreen" alt="Tests">
...
Pre-v1.0 (current version: `0.339.0`). All four implementation phases (Phase 1: framework; Phase 2: issuance + hardware; Phase 3: DEX + messaging; Phase 4: contracts + staking + cross-chain + multisig) are closed. The autonomous portion of the §56.3 pre-launch track is also closed; three user-driven items remain before v1.0.0 GA: external security audit, external accessibility audit, and Chrome Web Store submission. Audit-readiness packets ship with the repo.
...
```bash
pnpm test:smoke                                    # 470 smoke tests (plain Node: UI surfaces, signers, bridge, audits)
...
| Smoke - shells | 21 | Desktop keychain / packaging / hardening, mobile clipboard / shell / vault, popup / web / extension-sidepanel shells |
...
| **Smoke total** | **470** | All run on every commit; CI fails on any regression |
