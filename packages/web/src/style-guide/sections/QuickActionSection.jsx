    ...
    return (
        ...
        >
            <Guidance
                ...
                whenNot={<>Single-action contexts → use <code>&lt;Button variant="primary"&gt;</code>. Long lists → use a vertical card stack or a more list. Toolbar actions (filter / scan / etc.) → use the <code>PageHeader</code> trailing slot.</>}
