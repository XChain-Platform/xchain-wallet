    ...
    return (
        ...
        >
            <Guidance
                ...
                when={<>Bounded gray cards that represent a current selection within a vertical form (Receive's asset selector). Contrast with the asset hero — that's for screens where the asset is the page's lead and the icon stands alone in airy whitespace.</>}
