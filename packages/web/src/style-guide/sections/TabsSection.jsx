    ...
    return (
        ...
        >
            <Guidance
                ...
                when={<>Inside a routed panel where the user is switching VIEWS of the same record (Token detail's tabs over one token) or VIEWS of a related collection (Home tabs over the wallet). Tabs live at the top of the panel content, NOT in the PageHeader.</>}
                ...
                doRule={<>✓ Use this for primary panel-internal navigation · keep labels short (one or two words) · include counts when the data is countable and useful (Activity badges, Holders) · sort tabs in stable order by frequency of use or information progression</>}
