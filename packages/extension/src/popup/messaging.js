...
/** @param {{ walletId?: string, chainId?: string }} req */
export function listAutopayOrders(req) {
    return /** @type {any} */ (sendMessage('autopay.list', req));
}
/** @param {{ id?: string, chainId?: string, txid?: string, enabled: boolean }} req */
export function setAutopayEnabled(req) {
    return /** @type {any} */ (sendMessage('autopay.setEnabled', req));
}
/** @param {{ walletId?: string }} req */
export function getAutopayExposure(req) {
    return /** @type {any} */ (sendMessage('autopay.exposure', req));
}
/** @param {{ walletId?: string }} req */
export function resolveAutopayIndexes(req) {
    return /** @type {any} */ (sendMessage('autopay.resolveIndexes', req));
}
/** @param {{ walletId?: string }} req */
export function getAutopayStatus(req) {
    return /** @type {any} */ (sendMessage('autopay.status', req));
}
