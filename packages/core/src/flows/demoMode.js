 ...
 *
 * js/clear-text-storage-of-sensitive-data no-change: this IS a real wallet
 * password, but not real user secret material - it is auto-generated by
 * the wallet itself for a throwaway, zero-balance, auto-expiring demo
 * wallet the user never typed a password for and never entrusts real
 * funds to. Not persisting it would strand the user on the password
 * screen after every reload with a key they don't have. See above.
 */
